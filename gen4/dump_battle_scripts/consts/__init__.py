...
HGSS_COMMANDS = [
    *COMMON_COMMANDS,
    ...
    Command('End',[]),
    Command('ReduceWeight',[int]),
    Command('CalcHeavySlamPower',[]),
    Command('IsAttackerLevelLowerThanDefender',[Label]),
    Command('SetTailwindCounter',[int]),
    Command('GotoIfTailwindActive',[Battler, Label]),
    Command('GotoIfCurrentFieldIsType',[Terrain, Label]),
    Command('GotoIfMovePowerNotZero',[Label]),
    Command('GotoIfGrounded',[Battler, Label]),
    Command('GotoIfCurrentAdjustedMoveIsType',[Type, Label]),
    Command('GotoIfContactMove',[Label]),
    Command('GotoIfSoundMove',[Label]),
    Command('UpdateTerrainOverlay',[bool, Label]),
    Command('GotoIfTerrainOverlayIsType',[TerrainOverlay, Label]),
    Command('SetPsychicTerrainMoveUsedFlag',[]),
    Command('GotoIfFirstHitOfParentalBond',[Label]),
    Command('GotoIfSecondHitOfParentalBond',[Label]),
    Command('SetParentalBondFlag',[]),
    Command('GotoIfCurrentMoveIsValidForParentalBond',[Label]),
